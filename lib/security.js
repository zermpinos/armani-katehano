...
/**
 * Compares a plaintext password against the bcrypt hash in ADMIN_PASSWORD.
 *
 * S-03: Previously safePasswordCompare() hashed with SHA-256 -- not a KDF.
 * bcrypt with cost 12 is the industry standard for single-admin apps.
 *
 * ADMIN_PASSWORD must be a bcrypt hash starting with $2b$ or $2a$.
 * Generate: node -e "require('bcryptjs').hash('YOUR_PASSWORD',12).then(console.log)"
 */
