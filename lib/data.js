...
export const DEFAULT_PLAYERS = [
  ...
  { id:"p3",  number:5,  name:"Panagiotis Zermpinos",      position:"C",       height:"", weight:"", age:null, stats:{ ppg:0,rpg:0,orpg:0,drpg:0,apg:0,spg:0,bpg:0,tpg:0,fpg:0,fgPct:0,fg2Pct:0,fg3Pct:0,ftPct:0,mpg:0,eff:0 }, gameLog:[] },
...
export function recalcPlayerAverages(players, games) {
  return players.map(player => {
    ...
    // Build game log for charts (all games, with league+season for filtering)
    const gameLog = games
      .filter(g => g.boxScore)
      .map(g => {
