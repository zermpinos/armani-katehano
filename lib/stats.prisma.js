...
export async function recalcAggregates(seasonLeagueId, tx = prisma) {
  ...
  for (const playerId of playerIds) {
    ...
    // Raw totals -- used for accurate percentage calculation when merging leagues
    ...
    const aggregateData = {
      ...
      // Percentages stored per-league (accurate within one league)
      ...
      // Totals -- used for accurate cross-league percentage calculation
      ptsTotal:   totalPts,
      rebTotal:   totalReb,
      astTotal:   totalAst,
      fgmTotal:   totalFgm,
