    ...
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-ak-base border-b border-ak-border">
        ...
        <div className="max-w-[1280px] mx-auto px-4">
              ...
              {NAV_LINKS.map(link => {
                ...
                return (
                  <Link
                    ...
                    href={link.href}
                    className={[
                      "px-3 py-[6px] text-[11px] font-black tracking-[0.12em] uppercase rounded-md",
                      active
                        ? "text-ak-red-text bg-[#8b1a1a25]"
                        : "text-ak-text-dim bg-transparent",
                    ].join(" ")}
                  >
                    {link.label}
                  </Link>
          ...
          {/* Mobile dropdown */}
          {open && (
            <div className="sm:hidden border-t border-ak-border pb-2">
              {NAV_LINKS.map(link => {
                const active = router.pathname === link.href;
                return (
                  <Link
                    ...
                    className={[
                      "block px-4 py-3 text-[13px] font-black tracking-[0.12em] uppercase rounded-md my-0.5",
                      active
      ...
      <footer className="border-t border-ak-border px-4 py-5">
        <div className="max-w-[1280px] mx-auto flex flex-col items-center gap-3.5 text-center sm:flex-row sm:justify-between sm:text-left">
          ...
          <a
            ...
            className="flex items-center gap-2 text-[13px] font-black tracking-[0.08em] text-ak-text border border-ak-red-bright rounded-lg px-4 py-[7px] bg-gradient-to-br from-ak-red to-ak-base"
          >
          ...
          {/* Credit */}
          <div className="text-[11px] font-black tracking-[0.08em] text-ak-text">
