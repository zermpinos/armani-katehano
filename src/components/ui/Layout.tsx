      ...
      <footer className="border-t border-ak-border px-4 py-5">
        <div className="max-w-[1280px] mx-auto flex flex-col items-center gap-3.5 text-center sm:flex-row sm:justify-between sm:text-left">
          ...
          <a
            ...
            className="flex items-center gap-1.5 text-[11px] font-black tracking-[0.08em] text-ak-text-dim transition-colors duration-150 hover:text-ak-text border border-[#c0392b30] rounded-lg px-2 py-[3px]"
          >
